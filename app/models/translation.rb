class Translation < ActiveRecord::Base
  ...
  def translate
    ...
    translator = GoogleTranslate.new(ShopifyAPI::Product.find(:first).description, to_lang)
    ...
    ShopifyAPI::Product.find_each do |product|      
      ...
      metafield.load({
         ...
         :key => to_lang,
         :value => translator.translate(product.description),
         :value_type => 'string'
      })
    ...
    TranslationCompleteMailer.deliver_notification(ShopifyAPI::Shop.current.email)
  end
end
