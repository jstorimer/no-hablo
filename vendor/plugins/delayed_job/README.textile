...
* 1.7.1: Added description column which can optionally be set as a descriptor to a Job. An error will be raised if you try to create a DJ and your table does not have a :description column.
