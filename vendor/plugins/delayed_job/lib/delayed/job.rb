module Delayed
  ...
  class Job < ActiveRecord::Base
    ...
    def self.enqueue(*args, &block)
      ...
      Job.create(:payload_object => object, :priority => priority.to_i, :run_at => run_at, :description => description)
    rescue NoMethodError => e
      raise RuntimeError, "delayed_jobs table is missing the :description field. Please refer to README for details."
    end
