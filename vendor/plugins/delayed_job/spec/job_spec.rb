...
describe Delayed::Job do
  ...
  it "should add description to job if description is passed in" do
    Delayed::Job.enqueue SimpleJob.new, 5, nil, "Sample DJ"
    
    Delayed::Job.first.description.should == "Sample DJ"
  end
